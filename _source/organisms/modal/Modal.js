...
import ViewBookmark from './modals/ViewBookmark';
import LoadBookmarkTitle from './modals/LoadBookmarkTitle';
...
export default class Modal extends Component {
  constructor(props) {
    ...
    this.modalMap = {
      ...
      ViewBookmark: {
        modal: ViewBookmark,
        action: props.viewBookmark
      },
      LoadBookmarkTitle: {
        modal: LoadBookmarkTitle,
        action: props.loadBookmarkTitle
      },
      DeleteBookmark: {
...
Modal.propTypes = {
  ...
  loadBookmarkTitle: PropTypes.func.isRequired,

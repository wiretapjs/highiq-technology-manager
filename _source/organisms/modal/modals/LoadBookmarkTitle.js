...
export default class LoadBookmarkTitle extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Base onClose={ onClose } onSave={ () => { onSave(this.state); } } valid={ valid } headline="Load bookmark title">
...
LoadBookmarkTitle.propTypes = {
  onClose: PropTypes.func.isRequired,
  onSave: PropTypes.func.isRequired,
  data: PropTypes.object
};

LoadBookmarkTitle.defaultProps = {
  data: {}
};
